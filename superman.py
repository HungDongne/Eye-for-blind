...
class args():
    def __init__(self):
        ...
        self.loader_workers = 4  # Reduced from 10 to prevent CPU overload
        self.loader_shuffle = True
        self.pin_memory     = False
        self.image_resize   = [240, 426]
        self.device         = 'cpu'  # Changed from 'cuda' to 'cpu'
...
if __name__ == "__main__":
    ...
    #object detection
    parser.add_argument('--device', type=str, default='cpu', help='cuda device, i.e. 0 or 0,1,2,3 or cpu')  # Changed default to 'cpu'
